...
public final class QRCodeUtil extends LuminanceSource {
    ...
    public static void drawLogoQRCode(File logoFile, File codeFile, String qrUrl, String note) {
        try {
            ...
            for (int x = 0; x < 400; x++) { //WIDTH
                for (int y = 0; y < 400; y++) {  //HEIGHT
    ...
    public static void main(String[] args) {
        String text = "https://www.cnblogs.com/songyz/p/7490335.html"; // 随机生成验证码
        ...
        try {
            ...
            File output = new File("D:/withLogo.png");
            File logo = new File("D:/logo.png");
            drawLogoQRCode(logo,output,text,"baidu");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
